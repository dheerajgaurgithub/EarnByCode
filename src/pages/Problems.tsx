        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          ...
          >
            <div className="relative inline-block mb-6">
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent leading-tight">
                AlgoBucks Problems
              </h1>
              <motion.div 
              ...
              >
                <Sparkles className="w-8 h-8 lg:w-12 lg:h-12 text-blue-500 animate-pulse" />
              </motion.div>
            </div>
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl text-blue-700 mb-8 max-w-2xl mx-auto leading-relaxed"
            >
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-2xl px-6 py-4 shadow-lg shadow-blue-100/20 hover:shadow-blue-200/30 transition-all duration-300">
                <div className="flex items-center space-x-3">
                  <div className="p-2 bg-blue-100 rounded-xl">
                    <Target className="w-6 h-6 text-blue-600" />
                  </div>
                  <div className="text-left">
                    <div className="text-2xl font-bold text-blue-900">{filteredProblems.length}</div>
                    <div className="text-sm text-blue-600">Problems</div>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="bg-white/60 backdrop-blur-sm border border-blue-200/40 rounded-3xl p-6 lg:p-8 shadow-xl shadow-blue-100/10">
              <ProblemFilters
                search={search}
                setSearch={setSearch}
            ...
            {(search || difficulty !== 'All' || category !== 'All') && (
              <motion.div 
                ...
                className="mt-6 bg-white/40 backdrop-blur-sm border border-blue-200/30 rounded-2xl p-4 lg:p-6"
              >
                <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {search && (
                      <motion.div 
                        ...
                        animate={{ opacity: 1, scale: 1 }}
                        className="bg-blue-100/80 text-blue-800 px-4 py-2 rounded-xl flex items-center border border-blue-200/50 shadow-sm"
                      >
                        ...
                        <button 
                          onClick={() => setSearch('')}
                          className="ml-2 text-blue-600 hover:text-blue-800 transition-colors p-1 hover:bg-blue-200/50 rounded-full"
                        >
                          <X className="h-3 w-3" />
                        </button>
                      </motion.div>
                  ...
                  <motion.button 
                    ...
                    className="self-start lg:self-center text-blue-600 hover:text-blue-700 font-semibold transition-all duration-300 px-4 py-2 rounded-xl hover:bg-blue-100/50 border border-transparent hover:border-blue-200/50"
                  >
                    Clear All
                  </motion.button>
                </div>
            ...
            <div className="flex justify-center py-20">
              ...
              >
                <div className="relative mb-6">
                  ...
                  <div className="absolute inset-0 h-12 w-12 mx-auto border-2 border-blue-200 rounded-full animate-pulse"></div>
                </div>
                <p className="text-blue-600 text-lg font-medium">Searching challenges...</p>
              </motion.div>
            </div>
          ) : (
            <AnimatePresence mode="wait">
              ...
              >
                {filteredProblems.map((problem, index) => (
                  ...
                  >
                    <div className="bg-white/70 backdrop-blur-sm border border-blue-200/40 rounded-2xl lg:rounded-3xl shadow-lg shadow-blue-100/20 hover:shadow-blue-200/30 hover:border-blue-300/50 transition-all duration-300">
          ...
          {filteredProblems.length === 0 && !loading && !isSearching && (
            ...
            >
              <div className="max-w-2xl mx-auto">
                ...
                >
                  <div className="w-32 h-32 mx-auto bg-gradient-to-br from-blue-50 to-white rounded-3xl flex items-center justify-center border border-blue-200/50 shadow-xl shadow-blue-100/30">
                    <Search className="w-16 h-16 text-blue-300" />
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-200/20 via-blue-300/15 to-blue-200/20 rounded-3xl blur-xl animate-pulse"></div>
                </motion.div>
                ...
                >
                  <h3 className="text-3xl lg:text-4xl font-bold text-blue-900 mb-4">No Problems Found</h3>
                  <p className="text-blue-600 mb-8 text-lg leading-relaxed max-w-lg mx-auto">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={clearFilters}
                    className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-2xl hover:shadow-xl hover:shadow-blue-200/40 transition-all duration-300 text-lg border border-blue-500/30"
                  >
                    Reset All Filters
                  </motion.button>
                </motion.div>
