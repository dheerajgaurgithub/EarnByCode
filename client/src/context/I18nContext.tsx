...
const dictionaries: Record<LangCode, Record<string, string>> = {
  en: {
    ...
    'wallet.minimum_withdrawal': 'Minimum withdrawal: ₹10',
    ...
    // Contests
    'contests.title': 'AlgoBucks Contests',
    ...
    'contests.login_prompt': 'Please login to participate in contests and compete for prizes.',
    // Home
    ...
    // Brand
    'brand.tagline': 'Think smart. Code harder. Earn more.',
    'brand.description': 'The ultimate algorithmic trading platform where elite developers compete, earn AlgoBucks, and claim real rewards through skill-based algorithmic mastery.',
    // Register
    'register.title': 'Join AlgoBucks',
    'register.subtitle': 'Create your <b>AlgoBucks</b> account',
    ...
    'register.submit': 'Create AlgoBucks Account',
    ...
    'register.success': 'Registration successful! Welcome to AlgoBucks.',
    ...
    // Problems List
    'problems.title': 'AlgoBucks Problems',
  ...
  hi: {
    ...
    'wallet.minimum_withdrawal': 'न्यूनतम निकासी: ₹10',
    ...
    // Contests
    'contests.title': 'AlgoBucks प्रतियोगिताएँ',
    'contests.subtitle': 'दुनिया भर के डेवलपर्स के साथ प्रतिस्पर्धा करें और नकद इनाम जीतें! अपनी स्किल्स परखें और लीडरबोर्ड पर ऊपर चढ़ें।',
    ...
    'contests.empty.tab_desc': 'वर्तमान में {tab} प्रतियोगिताएँ उपलब्ध नहीं हैं।',
    ...
    'contests.login_prompt': 'कृपया प्रतियोगिताओं में भाग लेने और इनाम के लिए प्रतिस्पर्धा करने हेतु लॉगिन करें।',
    // Home
    ...
    // Problems List
    'problems.title': 'AlgoBucks समस्याएँ',
