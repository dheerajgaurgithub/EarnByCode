...
const dictionaries: Record<LangCode, Record<string, string>> = {
  ...
  es: {
    ...
    'login.subtitle': 'Inicia sesión en <b>EarnByCode</b>',
    'login.email': 'Correo electrónico',
    'login.password': 'Contraseña',
    'login.remember': 'Recuérdame',
    'login.forgot': '¿Olvidaste tu contraseña?',
    'login.submit': 'Iniciar sesión en EarnByCode',
  ...
  fr: {
    ...
    'login.subtitle': 'Connectez-vous à <b>EarnByCode</b>',
    'login.email': 'Adresse e-mail',
    'login.password': 'Mot de passe',
    'login.remember': 'Se souvenir de moi',
    'login.forgot': 'Mot de passe oublié ?',
    'login.submit': "Se connecter à EarnByCode",
  ...
  de: {
    ...
    'login.subtitle': 'Bei <b>EarnByCode</b> anmelden',
    'login.email': 'E-Mail-Adresse',
    'login.password': 'Passwort',
    'login.remember': 'Angemeldet bleiben',
    'login.forgot': 'Passwort vergessen?',
    'login.submit': 'Bei EarnByCode anmelden',
