...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50/30 to-slate-50 py-6 sm:py-8 lg:py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 px-2 sm:px-0">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-900 via-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4 leading-tight">
            AlgoBucks Blog
          </h1>
        ...
        {featuredPost && (
          <div className="mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-6 sm:mb-8">Featured Article</h2>
            <div className="bg-gradient-to-r from-blue-50/80 to-indigo-50/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl overflow-hidden border border-blue-200/50 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-center order-1 lg:order-2">
                  ...
                  <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 mb-4 hover:text-blue-600 transition-colors cursor-pointer leading-tight">
                    {featuredPost.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl text-sm sm:text-base">
                      Read More
        ...
        {/* Regular Posts Grid */}
        <div className="mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-6 sm:mb-8">Latest Articles</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {regularPosts.map((post) => (
              <article
                key={post.id}
                className="bg-white/70 backdrop-blur-sm rounded-xl sm:rounded-2xl overflow-hidden border border-blue-100 hover:border-blue-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group cursor-pointer"
              >
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center text-xs sm:text-sm text-slate-500 mb-3 gap-1 sm:gap-0">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-slate-800 mb-2 hover:text-blue-600 transition-colors leading-tight">
                    {post.title}
                  </h3>
                  <p className="text-sm sm:text-base text-slate-600 mb-4 line-clamp-3 leading-relaxed">{post.excerpt}</p>
        ...
        <div className="text-center mb-12 sm:mb-16">
          <button className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
            Load More Articles
            <ArrowRight className="w-4 h-4 ml-2" />
          </button>
        </div>
        ...
        {/* Categories Section */}
        <div className="mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 text-center mb-6 sm:mb-8">
            Browse by Category
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
            {categories.map((category) => {
              ...
              return (
                <div
                  key={category.name}
                  className="bg-white/60 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center border border-blue-100 hover:border-blue-300 hover:bg-white/80 transition-all duration-300 group cursor-pointer hover:-translate-y-1 hover:shadow-lg"
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-blue-100 mb-3 sm:mb-4 group-hover:bg-blue-200 transition-colors duration-300">
                    <IconComponent className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <h3 className="text-sm sm:text-base font-bold text-slate-700 group-hover:text-blue-600 transition-colors mb-1">
                    {category.name}
                  </h3>
        ...
        {/* Newsletter Section */}
        <div className="bg-gradient-to-r from-blue-50/80 to-indigo-50/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-blue-200/50 shadow-xl">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-lg mx-auto mb-4">
              <input
                ...
                className="flex-1 px-4 sm:px-6 py-3 sm:py-4 rounded-xl bg-white/80 border border-blue-200 text-slate-800 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm text-sm sm:text-base"
              />
              <button className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl whitespace-nowrap text-sm sm:text-base transform hover:scale-105">
                Subscribe Now
              </button>
            </div>
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8">
          <div className="text-center bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-blue-100">
            <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1">50+</div>
            <div className="text-sm sm:text-base text-slate-600">Articles</div>
          </div>
          <div className="text-center bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-blue-100">
            <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1">10K+</div>
            <div className="text-sm sm:text-base text-slate-600">Readers</div>
          </div>
          <div className="text-center bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-blue-100">
            <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1">5</div>
            <div className="text-sm sm:text-base text-slate-600">Categories</div>
          </div>
          <div className="text-center bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-blue-100">
            <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1">Weekly</div>
            <div className="text-sm sm:text-base text-slate-600">Updates</div>
          </div>
        </div>
