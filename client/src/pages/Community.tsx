  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50/30 to-slate-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 sm:py-20 lg:py-24 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-white/10 backdrop-blur-sm mb-6 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto sm:max-w-none">
            <a
              ...
              className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-blue-600 font-medium rounded-xl hover:bg-blue-50 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 sm:px-8 py-3 sm:py-4 bg-white/10 backdrop-blur-sm text-white font-medium rounded-xl hover:bg-white/20 transition-all duration-300 flex items-center justify-center gap-2 border border-white/20"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-900 to-indigo-600 bg-clip-text text-transparent mb-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white/70 backdrop-blur-sm p-6 sm:p-8 rounded-xl sm:rounded-2xl border border-blue-100 text-center hover:shadow-xl hover:border-blue-300 transition-all duration-300 hover:-translate-y-1 group">
              <div className="mx-auto flex items-center justify-center h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-blue-100 text-blue-600 mb-4 group-hover:bg-blue-200 transition-colors duration-300">
                <stat.icon className="h-6 w-6 sm:h-8 sm:w-8" />
              </div>
              <p className="text-2xl sm:text-3xl font-bold text-slate-800 mb-2">{stat.value}</p>
              <p className="text-sm sm:text-base font-medium text-slate-600">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Upcoming Events */}
      <div className="bg-white/50 backdrop-blur-sm py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 xl:grid-cols-3">
            {events.map((event) => (
              <div key={event.id} className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-md overflow-hidden border border-blue-100 hover:shadow-xl hover:border-blue-300 transition-all duration-300 hover:-translate-y-1 group">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4 flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <h3 className="text-lg sm:text-xl font-bold text-slate-800 leading-tight">{event.title}</h3>
                      ...
                      <p className="text-sm text-slate-500 mb-3">{event.date} • {event.time}</p>
                      <p className="text-sm text-slate-600 mb-4 leading-relaxed">{event.description}</p>
                    </div>
                  </div>
                  <div className="mt-6">
                    <button className="w-full flex justify-center items-center px-4 py-3 border border-transparent text-sm font-medium rounded-lg text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl">
                      Learn More & Register
                    </button>
                  </div>
                </div>
      ...
      <div className="bg-gradient-to-r from-blue-50/50 to-indigo-50/50 py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
            {guidelines.map((guideline, index) => (
              <div key={index} className="flex items-start group">
                <div className="flex-shrink-0 flex items-center justify-center h-12 w-12 sm:h-16 sm:w-16 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  <guideline.icon className="h-6 w-6 sm:h-8 sm:w-8" />
                </div>
                <div className="ml-6 sm:ml-8">
                  <h3 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">{guideline.title}</h3>
      ...
      {/* CTA Section */}
      <div className="bg-white/80 backdrop-blur-sm py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 rounded-2xl sm:rounded-3xl px-6 sm:px-12 py-12 sm:py-16 text-center text-white relative overflow-hidden">
            {/* Background decoration */}
            <div className="absolute inset-0 opacity-20">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto sm:max-w-none">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-xl text-blue-600 bg-white hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Join Discord Community
                </a>
                <button className="inline-flex items-center justify-center px-8 py-4 border border-white/30 text-base font-medium rounded-xl text-white bg-white/10 hover:bg-white/20 transition-all duration-300 backdrop-blur-sm">
                  Explore Features
                </button>
              </div>
            </div>
