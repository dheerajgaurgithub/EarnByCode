  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 text-gray-800">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-32 h-32 sm:w-48 sm:h-48 lg:w-72 lg:h-72 bg-blue-300/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 bg-blue-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
            ...
            <div className="bg-gradient-to-r from-white/90 via-blue-50/80 to-white/90 backdrop-blur-sm border border-blue-200/50 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 lg:p-8 shadow-xl shadow-blue-500/10 hover:shadow-blue-500/15 transition-all duration-500 mx-4 sm:mx-0">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4 lg:gap-6 text-center">
                {[
                  ...
                  { value: '50+', label: 'Contests Hosted', color: 'text-blue-800' },
